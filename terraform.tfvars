parameters = {
  ...
  "payment.dev.CART_HOST" = { type = "String",  value = "cart-dev.kr7348202.online:80" }
  ...
  "rabbtimq.dev.AMQP_USER" = { type = "String",  value = "roboshop" }
  "rabbtimq.dev.AMQP_PASS" = { type = "String",  value = "roboshop123" }
